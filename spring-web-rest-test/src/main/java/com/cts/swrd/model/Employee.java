...
@Pattern(regexp = "[1-9][0-9]{9}", message = "Mobile number is expected to be 10 digits not string") @NotNull(message = "Mobile number cannot be omitted") String mobileNumber,
