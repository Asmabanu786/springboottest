...
public class EmployeeServiceImpl implements EmployeeService{
	...
	public Employee save(Employee emp) throws EmployeeException {
		if(emp!=null) {
			...
			if(empRepo.existsById(emp.getEmpId())) {
				throw new EmployeeException("There does not exist an employee with the given ID");
	...
	@Override
	public List<Employee> findAllBybascRange(double lb, double ub) {
		return empRepo.finfAllByBasicRange(lb, ub);
	}
