...
public class DefaultController {
	...
	public ModelAndView defaultGetRequestHandler() {
		...
		mv.addObject("developers", new String[] { "Hardin", "Tessa", "Annatodd" });
		return mv;
	}
	...
	@GetMapping("/hello")
	public ModelAndView sayYoyo(
			@RequestParam(name="salut",required=false,defaultValue="Mr.") String salutation, 
			@RequestParam(name="unm",required=false,defaultValue="Everyone") String userName) { 
